...
<div class="container">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Your tree order list </h3>
...
$sql = "SELECT * FROM orders o WHERE o.G_ID IN (SELECT g.G_ID FROM GARDENS g WHERE g.S_ID='$user_check') ORDER BY order_date";
