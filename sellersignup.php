<html>
  ...
  <head>
    <title> Seller Signup | Tree Plantation </title>
  </head>

  <link rel="stylesheet" type = "text/css" href ="css/sellersignup.css">
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi, <br> Welcome to <span class="edit"> Tree Plantation </span></h1>
     <br>
   <p>Get started by creating your account</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
       ...
       <label style="margin-left: 5px;"><a href="sellerlogin.php">Have an account? Login</a></label>
