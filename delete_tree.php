...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="css/delete_tree.css">
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="delete_tree.php" class="list-group-item active">Delete Tree</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="delete_tree1.php" method="POST">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Delete your tree from here </h3>
...
$sql = "SELECT * FROM tree t WHERE t.options = 'ENABLE' AND t.G_ID IN (SELECT g.G_ID FROM GARDENS g WHERE g.S_ID='$user_check') ORDER BY T_ID";
...
if (mysqli_num_rows($result) > 0)
{
  ...
  <tbody>
    <tr>
      <td> <input name="checkbox[]" type="checkbox" value="<?php echo $row['T_ID']; ?>"/> </td>
