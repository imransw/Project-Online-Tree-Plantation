...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $F_ID = $values["tree_id"];
    $foodname = $values["tree_name"];
    $quantity = $values["tree_quantity"];
    $price =  $values["tree_price"];
    $total = ($values["tree_quantity"] * $values["tree_price"]);
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (T_ID, foodname, price,  quantity, order_date, username, G_ID) 
              VALUES ('" . $T_ID . "','" . $foodname . "','" . $price . "','" . $quantity . "','" . $order_date . "','" . $username . "','" . $G_ID . "')";
