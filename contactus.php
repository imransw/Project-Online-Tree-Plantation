...
<html>
  ...
  <head>
    <title> Contact | Tree Plantation </title>
  </head>
...
<ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-log-in"></span> Login <span class="caret"></span></a>
              ...
              <li> <a href="managerlogin.php"> Seller Login</a></li>
...
?>
    ...
    <div class="heading">
     <strong>Do you want to contact with<span class="edit"> Tree Plantation </span>?</strong>
     <br>
    You can discuss with us in detail.
    </div>
